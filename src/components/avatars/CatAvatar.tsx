...
/**
 * Cat Avatar — A cosmic cat with space helmet details,
 * pointy ears, and star-shaped blushes.
 */
export function CatAvatar({ status, isSpeaking }: Props) {
  return (
      ...
      <g transform="translate(100, 100)">
        ...
        {status === "connecting" ? (
          ...
          <>
            {/* Pupils */}
            <motion.circle
              cx="-30" cy={isSpeaking ? "-7" : "-3"} r="7" fill="#4C1D95"
              animate={{
                scaleY: [1, 1, 0.1, 1, 1],
              }}
        ...
        {/* Nose */}
        <path d="M -5 10 L 5 10 L 0 16 Z" fill="#F472B6" />
        ...
        <path
          ...
          strokeLinecap="round"
          fill="none"
          animate={isSpeaking ? { d: ["M -12 20 Q -6 32 0 20 Q 6 32 12 20", "M -8 20 Q -4 24 0 20 Q 4 24 8 20"] } : {}}
        />
